...
def deal_card():
    # Going to return a random card from the deck
    cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
    card = random.choice(cards)
    return card


# This function is going to take a list of cards as input
...
def play_game():
    ...
    # here the _ means that we don't need any variable for the for loop to run. We only need the for loop to run 2
    # times.
    for _ in range(2):
